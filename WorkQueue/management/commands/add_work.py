...
class Command(BaseCommand):
    ...
    supported_job_types = ('eval_loc_1', 'eval_loc_4', 'eval_loc_9', 'eval_loc_16', 'eval_claims')
    ...
    def add_arguments(self, parser):
        ...
        parser.add_argument('job', nargs=1, type=str, help='Job type: eval_loc_1/4/9/16')
        parser.add_argument('priority', nargs=1, type=int, help='Priority (lower numbers are handled first)')
        parser.add_argument('location', nargs=1, type=int, help='Location (1..64)')
