...
from Pieces8x2.models import Piece8x2


TEMPLATE_VIEW = 'pieces8x2/show.dtl'
...
class ShowPiecesView(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['pieces'] = pieces = Piece8x2.objects.filter(nr__gte=nr, nr__lt=nr+10).order_by('nr')
        for piece in pieces:
