...
class Command(BaseCommand):
    ...
    def _get_candidates_p11(self):
        ...
        for p11 in self._iter_no_border(11, side4=p10.exp_s4, side3=p19.exp_s3):
            ...
            for p2 in self._iter_border(2, side1=self.two_border, side3=p10.exp_s3):
                for _ in self._iter_border(3, side1=self.two_border, side4=p2.exp_s4, side3=p11.exp_s3):
                    nrs.append(p11.nr)
                    done = True
                    break
                # for
    ...
    def _get_candidates_p14(self):
        ...
        for p14 in self._iter_no_border(14, side2=p15.exp_s2, side3=p22.exp_s3):
            ...
            for p7 in self._iter_border(7, side1=self.two_border, side3=p15.exp_s3):
                for _ in self._iter_border(6, side1=self.two_border, side2=p7.exp_s2, side3=p14.exp_s3):
                    nrs.append(p14.nr)
                    done = True
                    break
                # for
    ...
    def _get_candidates_p18(self):
        ...
        for p18 in self._iter_no_border(18, side1=p10.exp_s1, side2=p19.exp_s2):
            ...
            for p9 in self._iter_border(9, side4=self.two_border, side2=p10.exp_s2):
                for _ in self._iter_border(17, side4=self.two_border, side1=p9.exp_s1, side2=p18.exp_s2):
                    nrs.append(p18.nr)
                    done = True
                    break
                # for
    ...
    def _get_candidates_p23(self):
        ...
        for p23 in self._iter_no_border(23, side1=p15.exp_s1, side4=p22.exp_s4):
            ...
            for p16 in self._iter_border(16, side2=self.two_border, side4=p15.exp_s4):
                for _ in self._iter_border(24, side2=self.two_border, side1=p16.exp_s1, side4=p23.exp_s4):
                    nrs.append(p23.nr)
                    done = True
                    break
                # for
    ...
    def _get_candidates_p42(self):
        ...
        for p42 in self._iter_no_border(42, side3=p50.exp_s3, side2=p43.exp_s2):
            ...
            for p49 in self._iter_border(49, side4=self.two_border, side2=p50.exp_s2):
                for _ in self._iter_border(41, side4=self.two_border, side3=p49.exp_s3, side2=p42.exp_s2):
                    nrs.append(p42.nr)
                    done = True
                    break
                # for
    ...
    def _get_candidates_p47(self):
        ...
        for p47 in self._iter_no_border(47, side3=p55.exp_s3, side4=p46.exp_s4):
            ...
            for p56 in self._iter_border(56, side2=self.two_border, side4=p55.exp_s4):
                for _ in self._iter_border(48, side2=self.two_border, side3=p56.exp_s3, side4=p47.exp_s4):
                    nrs.append(p47.nr)
                    done = True
                    break
                # for
    ...
    def _get_candidates_p51(self):
        ...
        for p51 in self._iter_no_border(51, side4=p50.exp_s4, side1=p43.exp_s1):
            ...
            for p58 in self._iter_border(58, side3=self.two_border, side1=p50.exp_s1):
                for _ in self._iter_border(59, side3=self.two_border, side4=p58.exp_s4, side1=p51.exp_s3):
                    nrs.append(p51.nr)
                    done = True
                    break
                # for
    ...
    def _get_candidates_p54(self):
        ...
        for p54 in self._iter_no_border(54, side2=p55.exp_s2, side1=p46.exp_s1):
            ...
            for p63 in self._iter_border(63, side3=self.two_border, side1=p55.exp_s1):
                for _ in self._iter_border(62, side3=self.two_border, side2=p63.exp_s2, side1=p54.exp_s1):
                    nrs.append(p54.nr)
                    done = True
                    break
                # for
