    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['nr1'], name='Partial6x6__nr1_1fe5eb_idx'),
                            models.Index(fields=['nr2'], name='Partial6x6__nr2_417f6d_idx'),
                            models.Index(fields=['nr3'], name='Partial6x6__nr3_80c958_idx'),
                            models.Index(fields=['nr4'], name='Partial6x6__nr4_3cf9c8_idx'),
                            models.Index(fields=['nr5'], name='Partial6x6__nr5_740d2b_idx'),
                            models.Index(fields=['nr6'], name='Partial6x6__nr6_069272_idx'),
                            models.Index(fields=['nr7'], name='Partial6x6__nr7_7fde20_idx'),
                            models.Index(fields=['nr8'], name='Partial6x6__nr8_c8f558_idx'),
                            models.Index(fields=['nr9'], name='Partial6x6__nr9_253e7b_idx'),
                            models.Index(fields=['nr10'], name='Partial6x6__nr10_f3c330_idx'),
                            models.Index(fields=['nr11'], name='Partial6x6__nr11_f02097_idx'),
                            models.Index(fields=['nr12'], name='Partial6x6__nr12_fba2f4_idx'),
                            models.Index(fields=['based_on_4x4'], name='Partial6x6__based_o_326676_idx'),
                            models.Index(fields=['processor'], name='Partial6x6__process_4f307c_idx')],
            },
        ),
    ]
