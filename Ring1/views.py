...
class ShowCorner1View(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            context['url_first'] = reverse('Ring1:show-c1', kwargs={'nr': Corner1.objects.order_by('nr').first().pk})
        else:
            # convert to Ring1
            ring1 = Ring1()
...
class ShowCorner2View(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            context['url_first'] = reverse('Ring1:show-c2', kwargs={'nr': Corner2.objects.order_by('nr').first().pk})
        else:
            # convert to Ring1
            ring1 = Ring1()
...
class ShowCorner3View(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            context['url_first'] = reverse('Ring1:show-c3', kwargs={'nr': Corner3.objects.order_by('nr').first().pk})
        else:
            # convert to Ring1
            ring1 = Ring1()
...
class ShowCorner4View(TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        try:
            ...
            context['url_first'] = reverse('Ring1:show-c4', kwargs={'nr': Corner4.objects.order_by('nr').first().pk})
        else:
            # convert to Ring1
            ring1 = Ring1()
