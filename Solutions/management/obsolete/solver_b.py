...
class Command(BaseCommand):
    ...
    # solve_order = (
    #     36, 35, 44, 43,           # center
    #     42, 50, 51, 52, 34,       # corner 1
    #
    #     28, 27, 26,
    #     18, 10, 19, 11, 20, 12,   # corner 2
    #
    #     37, 29, 45, 21,           # col 4
    #     38, 30,                   # col 5
    # )
    ...
    #     28, 35, 37, 44,      # +
    #     27, 29, 43, 45,      # ring 1
    #     50, 42, 51, 34, 52,  # corner
    # )

    # solve_order = (
    #         36, 28, 29, 37,     # ring 1
    #         44, 45, 35, 43, 27,  38, 46, 30,  20, 21, 19, 22,     # ring 2
    #
    # )
    ...
    def handle(self, *args, **options):
        ...
        while self.board_gap_count > 0:
            ...
            while not placed_piece:
                if self._try_fill_nr(nr, greater_than, min_options):
                    # success
